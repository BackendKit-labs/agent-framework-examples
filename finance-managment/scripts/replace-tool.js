...
const start = c.indexOf('return defineTool', idx);
const end = c.indexOf('      }', start + 2000);
const oldBlock = c.substring(start, end + 7);

const newBlock = `return defineTool({
...
if (c.includes(oldBlock)) {
  ...
  console.log('OK - Tool updated');
} else {
  console.log('NOT FOUND');
  console.log('First 100 chars of oldBlock:', oldBlock.substring(0, 100));
}
